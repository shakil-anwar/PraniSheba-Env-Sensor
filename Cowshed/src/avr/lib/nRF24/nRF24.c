...
uint32_t (*_seconds)(void) = NULL;

#if defined(ESP32_V010)
volatile bool nrfFlag;
#endif
...
void nrfSetPin(volatile gpio_pin cePin,volatile gpio_pin csnPin)
{
  _cePin = cePin;
  _csnPin = csnPin;
