...
#include "NewHttpClient.h"
#include "b64.h"

// Initialize constants
const char* NewHttpClient::kUserAgent = "Arduino/2.2.0";
const char* NewHttpClient::kContentLengthPrefix = HTTP_HEADER_CONTENT_LENGTH ": ";
const char* NewHttpClient::kTransferEncodingChunked = HTTP_HEADER_TRANSFER_ENCODING ": " HTTP_HEADER_VALUE_CHUNKED;

NewHttpClient::NewHttpClient(Client& aClient, const char* aServerName, uint16_t aServerPort)
...
NewHttpClient::NewHttpClient(Client& aClient, const String& aServerName, uint16_t aServerPort)
 : NewHttpClient(aClient, aServerName.c_str(), aServerPort)
{
}

NewHttpClient::NewHttpClient(Client& aClient, const IPAddress& aServerAddress, uint16_t aServerPort)
...
void NewHttpClient::stop()
{
  iClient->stop();
  resetState();
}

void NewHttpClient::connectionKeepAlive()
{
  iConnectionClose = false;
}

void NewHttpClient::noDefaultRequestHeaders()
{
  iSendDefaultRequestHeaders = false;
}

void NewHttpClient::beginRequest()
{
  iState = eRequestStarted;
}

int NewHttpClient::startRequest(const char* aURLPath, const char* aHttpMethod, 
...
int NewHttpClient::sendInitialHeaders(const char* aURLPath, const char* aHttpMethod)
{
#ifdef LOGGING
...
void NewHttpClient::sendHeader(const char* aHeader)
{
    iClient->println(aHeader);
}

void NewHttpClient::sendHeader(const char* aHeaderName, const char* aHeaderValue)
{
...
void NewHttpClient::sendHeader(const char* aHeaderName, const int aHeaderValue)
{
    iClient->print(aHeaderName);
    iClient->print(": ");
    iClient->println(aHeaderValue);
...
void NewHttpClient::sendBasicAuth(const char* aUser, const char* aPassword)
{
...
void NewHttpClient::finishHeaders()
{
    iClient->println();
    iState = eRequestSent;
}

void NewHttpClient::flushClientRx()
{
...
void NewHttpClient::endRequest()
{
    beginBody();
}

void NewHttpClient::beginBody()
{
...
int NewHttpClient::get(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_GET);
}

int NewHttpClient::get(const String& aURLPath)
{
    return get(aURLPath.c_str());
}

int NewHttpClient::post(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_POST);
}

int NewHttpClient::post(const String& aURLPath)
{
    return post(aURLPath.c_str());
}

int NewHttpClient::post(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return post(aURLPath, aContentType, strlen(aBody), (const byte*)aBody);
}

int NewHttpClient::post(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return post(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int NewHttpClient::post(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_POST, aContentType, aContentLength, aBody);
}

int NewHttpClient::put(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_PUT);
}

int NewHttpClient::put(const String& aURLPath)
{
    return put(aURLPath.c_str());
}

int NewHttpClient::put(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return put(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int NewHttpClient::put(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return put(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int NewHttpClient::put(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_PUT, aContentType, aContentLength, aBody);
}

int NewHttpClient::patch(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_PATCH);
}

int NewHttpClient::patch(const String& aURLPath)
{
    return patch(aURLPath.c_str());
}

int NewHttpClient::patch(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return patch(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int NewHttpClient::patch(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return patch(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int NewHttpClient::patch(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_PATCH, aContentType, aContentLength, aBody);
}

int NewHttpClient::del(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_DELETE);
}

int NewHttpClient::del(const String& aURLPath)
{
    return del(aURLPath.c_str());
}

int NewHttpClient::del(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return del(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int NewHttpClient::del(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return del(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int NewHttpClient::del(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_DELETE, aContentType, aContentLength, aBody);
}

int NewHttpClient::responseStatusCode()
{
    if (iState < eRequestSent)
    {
        return HTTP_ERROR_API;
...
int NewHttpClient::skipResponseHeaders()
{
...
String NewHttpClient::responseBody()
{
...
bool NewHttpClient::endOfBodyReached()
{
...
bool NewHttpClient::headerAvailable()
{
...
String NewHttpClient::readHeaderName()
{
...
String NewHttpClient::readHeaderValue()
{
    int colonIndex = iHeaderLine.indexOf(':');
...
int NewHttpClient::read(uint8_t *buf, size_t size)
{
